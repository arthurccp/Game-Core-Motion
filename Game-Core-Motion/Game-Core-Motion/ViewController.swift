...
//  Game-Core-Motion
//
//  Created by Arthur on 28/06/2023.
...
class ViewController: UIViewController {
    ...
    func rotateWorld(){
        let randomAngle = Double(arc4random_uniform(100))/100 - 0.6
        isMoving = true
    ...
    func checkGameOver(){
        ...
        let playerAngle = atan2(Double(player.transform.a),Double(street.transform.b))
